...
ActiveRecord::Schema.define(version: 2020_02_20_183928) do
  ...
  create_table "bills", force: :cascade do |t|
    t.bigint "parliamentary_session_id", null: false
    t.string "code"
    t.string "title"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["parliamentary_session_id"], name: "index_bills_on_parliamentary_session_id"
  end
  ...
  create_table "parliamentary_sessions", force: :cascade do |t|
    t.integer "number"
    t.date "start_date"
    t.date "end_date"
    t.datetime "created_at", precision: 6, null: false
  ...
  add_foreign_key "bills", "parliamentary_sessions"
